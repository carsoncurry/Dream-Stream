                ...
                <div className="section no-pad-bot">
                    <div className="container">
                        ...
                        <div className="row center">
                            ...
                            <Parallax imageSrc=".public/images/streaming1.jpg" />
                                    ...
                                    <div className="row grey darken-4">
                                        <div className="col s12 m4 grey darken-4">
                                            <div className="icon-block">
                                                <h2 className="center white-text"><i class="material-icons">favorite</i></h2>
                                        ...
                                        <div className="col s12 m4">
                                            <div className="icon-block">
                                                <h2 className="center white-text"><i class="material-icons">mood</i></h2>
                                        ...
                                        <div className="col s12 m4">
                                            <div className="icon-block">
                                                <h2 className="center white-text"><i class="material-icons">monetization_on</i></h2>
                            ...
                            <Parallax src="./public/images/streaming2.jpg" />
                            ...
                            <Footer className="light-blue darken-2" copyrights="Made by FrontRow"
                                ...
                                links={
                                    <div>
                                        ...
                                        <ul>
                                            <li><a className="grey-text text-lighten-3" href="#!">John Caldwell</a></li>
                                            <li><a className="grey-text text-lighten-3" href="#!">Carson Curry</a></li>
                                            <li><a className="grey-text text-lighten-3" href="#!">Melissa Murphey</a></li>
                                            ...
                                            <h4>Connect</h4>
                                        <ul>
                                            <li><a className="grey-text text-lighten-3" href="#!"><i class="material-icons md-18">email</i>Contact John</a></li>
                                            <li><a className="grey-text text-lighten-3" href="#!"><i class="material-icons md-18">email</i>Contact Carson</a></li>
                                            <li><a className="grey-text text-lighten-3" href="#!"><i class="material-icons md-18">email</i>Contact Melissa</a></li>
